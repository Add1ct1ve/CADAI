...
- Composite real-world objects lack overall dimensions or key features (ask for size, detail level, and required subcomponents)
...
- Prioritize questions about overall size (L/W/H), level of detail, and essential subcomponents when the object is underspecified

...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum RetrievalBudgetMode {
    Fixed,
    Adaptive,
}

impl Default for RetrievalBudgetMode {
    fn default() -> Self {
        Self::Adaptive
    }
}
...
pub struct AppConfig {
    ...
    #[serde(default = "default_retrieval_budget_mode")]
    pub retrieval_budget_mode: RetrievalBudgetMode,
    #[serde(default = "default_retrieval_budget_128k")]
    pub retrieval_budget_128k: u32,
    #[serde(default = "default_retrieval_budget_200k")]
    pub retrieval_budget_200k: u32,
    #[serde(default = "default_retrieval_budget_400k")]
    pub retrieval_budget_400k: u32,
    #[serde(default = "default_retrieval_budget_1m")]
    pub retrieval_budget_1m: u32,
    #[serde(default = "default_true")]
...
fn default_retrieval_budget_mode() -> RetrievalBudgetMode {
    RetrievalBudgetMode::Adaptive
}

fn default_retrieval_budget_128k() -> u32 {
    12_000
}

fn default_retrieval_budget_200k() -> u32 {
    18_000
}

fn default_retrieval_budget_400k() -> u32 {
    28_000
}

fn default_retrieval_budget_1m() -> u32 {
    48_000
}
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            retrieval_budget_mode: default_retrieval_budget_mode(),
            retrieval_budget_128k: default_retrieval_budget_128k(),
            retrieval_budget_200k: default_retrieval_budget_200k(),
            retrieval_budget_400k: default_retrieval_budget_400k(),
            retrieval_budget_1m: default_retrieval_budget_1m(),
